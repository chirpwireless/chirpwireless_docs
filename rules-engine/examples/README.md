...
- **[Home Comfort and Energy](home-comfort-and-energy.md)** — Keep your living spaces in the right range. Temperature zones, garden moisture, wine cellar climate monitoring, and more.

- **[Safety and Alerting](safety-and-alerting.md)** — React fast when something is wrong. Water leak detection, doors opening at unusual hours, and sensors that should not be in a certain state.
...
- You have at least one alert rule set up in the [Alerts](../../alarm/) section for the automation to trigger
- You are comfortable with the basics covered in [Your First Automation](../your-first-automation/)
