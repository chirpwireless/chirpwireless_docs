...
- **Dashboard settings** (gear icon) — Opens the management dialog for folders and reordering, covered in [Organizing Your Views](organizing-your-views.md).
...
- **Folder** — Choose a folder for the dashboard, or leave it at **"None (top level)"** to place it directly in the sidebar. If you've created folders (through [Organizing Your Views](organizing-your-views.md)), they appear in the dropdown. This option only shows up when creating a new dashboard — not when editing later.
...
You can't change the folder from this dialog — moving a dashboard between folders is done through [Organizing Your Views](organizing-your-views.md).
