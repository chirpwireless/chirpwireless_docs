...
* [Placing objects](placing-objects.md) — How to place, turn, and arrange objects
* [Connecting sensors and colors](binding-sensors-and-colors.md) — Turn objects into live indicators
