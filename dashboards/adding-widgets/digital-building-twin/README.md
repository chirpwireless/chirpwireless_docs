...
* **A 3D model of your home** — draw walls, doors, and windows across as many floors as your house has, in a flat 2D view or a 3D view. See [Drawing your home](drawing-your-building.md).
* **A head start from a plan** — if you have a floor plan as a DXF file, import it instead of drawing. See [Importing a floor plan](importing-a-dxf-plan.md).
* **A model traced from a map** — draw your home's outline straight onto a satellite map. See [Tracing from the map](tracing-from-the-map.md).
* **A furnished home** — add sofas, beds, the fridge, a parking spot, and more from the object library. See [Placing objects](placing-objects.md) and the [Object library](object-catalog.md).
* **A live picture of your home** — connect sensors to objects and choose colors so the model reacts as things change. See [Connecting sensors and colors](binding-sensors-and-colors.md).
* **Readings shown right in the room** — pin a sensor's value to a spot in the model. See [Pins and live readings](drop-pins-and-live-values.md).
* **A home placed on the real map** — anchor your home to its real-world location. See [GPS anchoring](gps-anchoring.md).
...
1. Open the dashboard you'd like it on and switch the dashboard to **edit mode**. (Not sure how? [Adding Widgets](../README.md) explains edit mode and the widget picker.)
...
* New here? Read the [Editor tour](editor-tour.md) first to learn your way around.
* Want to dive in? Go to [Drawing your home](drawing-your-building.md).
* Got a floor plan already? See [Importing a floor plan](importing-a-dxf-plan.md).

## See also

* [Adding Widgets](../README.md) — Edit mode and the widget picker
* [Conditions](../conditions.md) — How color rules work across your widgets
